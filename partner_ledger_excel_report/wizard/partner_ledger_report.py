...
class PartnerLedgerExcelWizard(models.TransientModel):
    ...
    def action_export_excel(self):
        ...
        move_lines = self.env['account.move.line'].search(move_line_domain, order="partner_id, date asc, id asc")
        ...
        for partner, lines in partner_groups.items():
            ...
            headers = ["Date", "Due Date", "Journal", "Account", "Ref", "Debit", "Credit", "Balance"]
